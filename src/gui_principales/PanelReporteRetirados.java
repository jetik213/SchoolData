...
public class PanelReporteRetirados extends JPanel implements MouseListener, KeyListener, ActionListener {
	...
	protected void actionPerformedBtnReporte(ActionEvent e) {
		...
		List<AlumnoEntity> listUsuarios = gestionUsuario.listarAlumnosRetirados();
		...
		String file = ReporteRepositorio.REPORTE_ALUMNOS_RETIRADOS;
